...
public class BloodTypeAdapter extends BaseAdapter {
    Context context;
    LayoutInflater layoutInflater;
    ArrayList<BoodTypeSpinnnerModel> spinnnerArrayList;

    public BloodTypeAdapter(Context context, ArrayList<BoodTypeSpinnnerModel> spinnnerArrayList) {
